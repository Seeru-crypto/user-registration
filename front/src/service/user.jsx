...
export function postUser(name, sectorIds, agreeToTerms) {
    return axios
        .post('http://localhost:8880/accounts', {
            name,
            sectors: mapIdsToEntities(sectorIds),
            agreeToTerms: String(agreeToTerms),
        })
...
export function getUserSectors() {
    return axios
        .get('http://localhost:8880/sectors')
        .then(function (response) {
            return response.data;
        })
        .catch(function (error) {
...
export function getAccounts() {
    return axios
        .get('http://localhost:8880/accounts')
        .then(function (response) {
            return response.data;
        })
        .catch(function (error) {
