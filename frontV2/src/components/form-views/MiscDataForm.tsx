...
const MiscDataForm = (): JSX.Element => {
    ...
    <MiscDataFormStyle>
      ...
      <form className="dataForm" onSubmit={() => handleSubmit(onSubmit)}>
        ...
        <div className="buttonGrp">
          <FormButton onClick={() => dispatch(setCurrentStep(currentStepIndex - 1))} type="button" value="back" testId="back" />
